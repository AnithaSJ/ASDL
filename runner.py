...
#########################################
## START - Update
from code_completion_final import Code_Completion_Final

training_dir = "D:/ajagadis/ASDL/ASDL2018-master/training_data/programs_1000/"
query_dir = "D:/ajagadis/ASDL/ASDL2018-master/training_data/programs_200/"

model_file = "D:/ajagadis/ASDL/ASDL2018-master/Model_1/trained_model"
...
#########################################
## START - Update
code_completion = Code_Completion_Final()
## END 
#########################################
...
for tokens in query_token_lists:
    ...
    #completion = code_completion.query(prefix, suffix, len(expected)) 
