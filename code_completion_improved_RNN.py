...
class Code_Completion_Baseline_Improved:
    ...
    def create_network(self):
        ...
        self.net = tflearn.regression(self.net, optimizer='sgd', loss='mean_square',
                                 learning_rate= 1e-5)
    ...
    def train(self, token_lists, model_file):
        ...
        self.create_network()
        self.model.fit(xs, ys, n_epoch=10, batch_size=32, snapshot_step=300, snapshot_epoch=False, show_metric=True)
